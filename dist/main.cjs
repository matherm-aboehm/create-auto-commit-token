...
var import_meta_dirname;
var init_import_meta_dirname = __esm({
  "import-meta-dirname.js"() {
    import_meta_dirname = require("path").join(__dirname, "..");
  }
});
...
var require_windowsPtyAgent = __commonJS({
  "node_modules/node-pty/lib/windowsPtyAgent.js"(exports2) {
    ...
    var WindowsPtyAgent = (
      /** @class */
      (function() {
        function WindowsPtyAgent2(file, args, env, cwd, cols, rows, debug2, _useConptyDll, conptyInheritCursor) {
          var _this = this;
          ...
          var term = conptyNative.startProcess(file, cols, rows, debug2, this._generatePipeName(), conptyInheritCursor, this._useConptyDll);
          this._fd = term.fd;
          this._pty = term.pty;
          ...
          var inSocketFD = fs3.openSync(term.conin, "w");
        ...
        WindowsPtyAgent2.prototype._completePtyConnection = function() {
          var _this = this;
          if (!this._pendingPtyInfo) {
            return;
          }
          var _a = this._pendingPtyInfo, pty2 = _a.pty, commandLine = _a.commandLine, cwd = _a.cwd, env = _a.env;
          this._pendingPtyInfo = void 0;
          var connect = conptyNative.connect(pty2, commandLine, cwd, env, this._useConptyDll, function(c) {
  ...
  "node_modules/node-pty/lib/windowsTerminal.js"(exports2) {
    ...
    var WindowsTerminal = (
      ...
      (function(_super) {
        ...
        WindowsTerminal2.prototype.resize = function(cols, rows, pixelSize) {
          var _this = this;
  ...
  "node_modules/node-pty/lib/unixTerminal.js"(exports2) {
    ...
    var UnixTerminal = (
      ...
      (function(_super) {
        ...
        UnixTerminal2.prototype.resize = function(cols, rows, pixelSize) {
          var _a, _b;
          if (cols <= 0 || rows <= 0 || isNaN(cols) || isNaN(rows) || cols === Infinity || rows === Infinity) {
            throw new Error("resizing must be done using positive cols and rows");
          }
          ...
          pty2.resize(this._fd, cols, rows, pixelWidth, pixelHeight);
          this._cols = cols;
          this._rows = rows;
        };
    ...
    var CustomWriteStream = (
      ...
      (function() {
        ...
        CustomWriteStream2.prototype._processWriteQueue = function() {
          ...
          fs3.write(this._fd, task.buffer, task.offset, function(err, written) {
            if (err) {
...
var github_api_url = getInput("github-api-url").replace(/\/$/, "");
var github_token = getInput("github-token");
var exec2 = (cmd, args = [], options = {}) => new Promise((resolve2, reject) => {
  ...
  proc.onExit(({ exitCode: code }) => {
    ...
    ;
    return resolve2(code);
  });
  proc.onData((data) => process.stdout.write(data));
});
var main = async (owner2, repositories2, core, skipTokenRevoke2) => {
  let parsedOwner = "";
...
- ${parsedOwner}/${repo}`).join("")}`
  ...
  let workingDir = process.env.GITHUB_ACTION_PATH || import_meta_dirname;
